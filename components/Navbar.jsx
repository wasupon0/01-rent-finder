...
const Navbar = () => {
  ...
  return (
    <nav className="bg-orange-600 border-b border-orange-500">
        ...
        <div className="relative flex items-center justify-between h-20">
          <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center p-2 text-gray-100 rounded-md hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
          ...
          <div className="flex items-center justify-center flex-1 md:items-stretch md:justify-start">
            ...
            <Link className="flex items-center flex-shrink-0" href="/">
              <Image className="w-auto h-10" src={logo} alt="RentFinder" />
                ...
                {isProfileMenuOpen && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-orange-200"
                      role="menuitem"
                      tabIndex="-1"
                      id="user-menu-item-2"
                    >
